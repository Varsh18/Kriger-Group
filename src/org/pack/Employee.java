...
public class Employee {
  ...
  public String generate(int c) {
    ...
    public String insertEmployee(String[] emp,String email){
    	String eid;
    	...
    	try {
			s.executeUpdate("INSERT INTO kriger.employee_personel(id,eid,email,password,name,middlename,lname,gender,fname,mname,dob,jdate,role,rhead,bloodgroup,type,status) Values('"+c+"','"+eid+"','"+email+"','"+emp[0].concat("@kriger123")+"','"+emp[0]+"','"+emp[11]+"','"+emp[1]+"','"+emp[2]+"','"+emp[3]+"','"+emp[4]+"','"+dob+"','"+jdate+"','"+emp[7]+"','"+emp[8]+"','"+emp[9]+"','"+emp[10]+"','"+emp[12]+"')");
